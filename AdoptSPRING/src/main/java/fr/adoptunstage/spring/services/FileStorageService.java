...
import fr.adoptunstage.spring.exception.FileStorageException;
import fr.adoptunstage.spring.exception.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, String username) {
        // Normalize file name
        String fileName = StringUtils.cleanPath(username + file.getOriginalFilename());
