	...
	public String signupEntreprise() {
		String str = "<html>" +
                "<body>" +
					...
					"<br>puis saisissez le mail et le mot de passe renseigné lors de votre inscription.</p>" +
					"<br><br>" +
					...
					+ "</ol>" +
					"<p>Si vous avez des questions au sujet de votre compte ou autre, n'hésite pas à nous contacter"
	...
	public String signupStagiaire() {
		String str = "<html>" +
                "<body>" +
					...
					"<a href=\"http://localhost:4200/connexion\">Connexion</a>," +
					"<br>puis saisi le mail et le mot de passe renseigné lors de ton inscription.</p>" +
					"<br><br>" +
					"<p>Identifiant d'inscription : " + this.email +
					"<br><br>" +
