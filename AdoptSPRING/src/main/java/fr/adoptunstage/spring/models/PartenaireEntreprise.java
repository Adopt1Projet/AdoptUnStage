...
@Entity
@Table(name = "partenaire_entreprises")
public class PartenaireEntreprise {
	...
	public PartenaireEntreprise() {}

	public PartenaireEntreprise(String nom, String description, String siteWeb) {
		super();
		this.nom = nom;
		this.description = description;
		this.siteWeb = siteWeb;
	...
	public String toString() {
		return "Entreprise [id=" + id + ", nom=" + nom + ", description=" + description + ", siteWeb=" + siteWeb
				+ ", logo=" + logo + "]";
	}
